...
class TestSuite extends FunSuite {
	...
	test("donation.toString") {
		new test1 {
			assert(donations(0).toString === "donation:C00629618|PEREZ, JOHN A|90017|2017|40|H6CA34245")
		}
	}
	...
	trait YearlyDonations extends TestOutput {
		val lines = """C00384516|N|M2|P|201702039042410894|15|IND|SABOURIN, JOE|LOOKOUT MOUNTAIN|GA|028956146|UNUM|SVP, CORPORATE COMMUNICATIONS|01012014|484||PR2283904845050|1147350||P/R DEDUCTION ($192.00 BI-WEEKLY)|4020820171370029339
	...
	trait JoeIsDoingBetterFinanciallyIn2017 extends TestOutput {
		val lines = """C00384516|N|M2|P|201702039042410894|15|IND|SABOURIN, JOE|LOOKOUT MOUNTAIN|GA|028956146|UNUM|SVP, CORPORATE COMMUNICATIONS|01012016|5||PR2283904845050|1147350||P/R DEDUCTION ($192.00 BI-WEEKLY)|4020820171370029339
	...
	test("Percentile Computation") {
		...
		assert(Common.computePercentile(5)(l) === 15)
		assert(Common.computePercentile(30)(l) === 20)
		assert(Common.computePercentile(40)(l) === 20)
		assert(Common.computePercentile(50)(l) === 35)
		assert(Common.computePercentile(100)(l) === 50)
